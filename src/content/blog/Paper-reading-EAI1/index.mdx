...
<ArxivRating id='2308.16911' tldr='点云版本的 VLM' rank={4}>
...
<ArxivRating id='2305.15021' tldr='使用 Q-Former 范式的多模态 VLA，直接输出 low level policy' rank={3}>
...
<ArxivRating id='2407.15208' tldr='Object Centric 的 Flow Generation，并且使用 Flow 来进一步生成 low level policy' rank={4}>
...
<ArxivRating id='2307.05973' tldr='通过 LLM 和 VLM 获取图像表征，输出价值图以指导轨迹规划' rank={3}>
...
<ArxivRating id='2306.17582' tldr='使用 ChatGPT 进行机器人应用的发散性思考，提出了 PromptCraft 等工具' rank={2}>
